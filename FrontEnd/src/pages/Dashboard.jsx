...
// Fetch tasks from the server
        ...
        try {
            const response = await fetch('http://localhost:8081/tasks', {
                ...
                method:'GET',
                headers: {
                    'Authorization': `Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJleGFtcGxlQGV4YW1wbGUuY29tIiwidXNlck5hbWUiOiJqb2huX2RvZSIsInJvbGUiOlsiQURNSU4iXSwiZXhwIjoxNzMyMjUyMTE5fQ.ofcjwTC6fAAVgvL5hrZzOS8UpfTlnMBYrH2uzNrPvos`, // Use 'Bearer' followed by a space and your token
    ...
    const fetchSearchedTasks = async (status) => {
        alert("called")
        console.log("this is toke",token,"id",id)
        try {
    ...
    const deleteTask = async (id) => {
        console.log("this is delte tast",id)
        try {
